...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("zip:zip: commons-math4-core              4.0-beta1  java-archive/java-archive \n" +
                // "zip:jar:war: commons-math4-legacy            4.0-beta1  web-archive/java-archive\n" +
                // "zip:jar: commons-math4-legacy-core       4.0-beta1  roshal-archive/java-archive\n" +
                // "war:zip: commons-math4-legacy-exception  4.0-beta1  java-archive\n" +
                // "war: commons-math4-neuralnet         4.0-beta1  java-archive\n" +
